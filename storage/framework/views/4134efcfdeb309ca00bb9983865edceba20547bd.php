...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <?php if(!empty($credentialItems)): ?>
                                            <div class="payment-channel-credentials-card border mb-3">
                                                ...
                                                <?php $__currentLoopData = $credentialItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $credentialKey => $credentialItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(is_array($credentialItem)): ?>
                                                        <div class="form-group">
                                                            <label><?php echo e($credentialKey); ?></label>
                                                            <select name="credentials[<?php echo e($credentialKey); ?>]" class="form-control">
                                                                <option value=""><?php echo e(trans('update.select_a_option')); ?></option>

                                                                <?php $__currentLoopData = $credentialItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($cItem); ?>" <?php echo e((!empty($paymentChannel) and !empty($paymentChannel->credentials) and !empty($paymentChannel->credentials[$credentialKey]) and $paymentChannel->credentials[$credentialKey] == $cItem) ? 'selected' : ''); ?>><?php echo e($cItem); ?></option>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/unicuc/resources/views/admin/settings/financial/payment_channel/create.blade.php ENDPATH**/ ?>