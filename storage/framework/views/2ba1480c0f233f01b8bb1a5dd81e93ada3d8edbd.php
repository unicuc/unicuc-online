    ...
    <div class="col-12 col-md-4 mt-15">
        ...
        <?php if(!empty(getGeneralSettings('content_translate'))): ?>
            <div class="form-group">
                ...
                <select name="locale" class="custom-select <?php echo e(!empty($bundle) ? 'js-edit-content-locale' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>">
                    <option <?php echo e(!empty($bundle) ? '' : 'selected'); ?> disabled><?php echo e(trans('public.choose_instructor')); ?></option>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-15">
            ...
            <input type="text" name="title" value="<?php echo e((!empty($bundle) and !empty($bundle->translate($locale))) ? $bundle->translate($locale)->title : old('title')); ?>" class="form-control <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-15">
            ...
            <input type="text" name="seo_description" value="<?php echo e((!empty($bundle) and !empty($bundle->translate($locale))) ? $bundle->translate($locale)->seo_description : old('seo_description')); ?>" class="form-control <?php $__errorArgs = ['seo_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-15">
            ...
            <div class="input-group">
                ...
                <input type="text" name="image_cover" id="cover_image" value="<?php echo e(!empty($bundle) ? $bundle->image_cover : old('image_cover')); ?>" placeholder="<?php echo e(trans('forms.course_cover_size')); ?>" class="form-control <?php $__errorArgs = ['image_cover'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="js-video-demo-other-inputs form-group mt-0 <?php echo e((empty($bundle) or !in_array($bundle->video_demo_source, ['secure_host', 's3'])) ? '' : 'd-none'); ?>">
            ...
            <div class="input-group js-video-demo-path-input">
                <div class="input-group-prepend">
                    <button type="button" class="js-video-demo-path-upload input-group-text text-white panel-file-manager <?php echo e((empty($bundle) or empty($bundle->video_demo_source) or $bundle->video_demo_source == 'upload') ? '' : 'd-none'); ?>" data-input="demo_video" data-preview="holder">
                        <i data-feather="upload" width="18" height="18" class="text-white"></i>
                    </button>

                    <button type="button" class="js-video-demo-path-links rounded-left input-group-text input-group-text-rounded-left text-white <?php echo e((empty($bundle) or empty($bundle->video_demo_source) or $bundle->video_demo_source == 'upload') ? 'd-none' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(trans('forms.webinar_description_placeholder')); ?>"><?php echo (!empty($bundle) and !empty($bundle->translate($locale))) ? $bundle->translate($locale)->description : old('description'); ?></textarea>
        ...
        <div class="col-6">
            ...
            <div class="form-group mt-30 d-flex align-items-center">
                ...
                <div class="ml-30 custom-control custom-switch">
                    <input type="checkbox" name="private" class="custom-control-input" id="privateSwitch" <?php echo e((!empty($bundle) and $bundle->private) ? 'checked' :  ''); ?>>
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <?php $__env->stopPush(); ?>
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/unicuc/resources/views/web/default/panel/bundle/create_includes/step_1.blade.php ENDPATH**/ ?>