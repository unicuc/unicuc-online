                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle font-weight-500">
                                            <?php if(!empty($ReserveMeeting->sale) and !empty($ReserveMeeting->sale->total_amount) and $ReserveMeeting->sale->total_amount > 0): ?>
                                                <?php echo e(handlePrice($ReserveMeeting->sale->total_amount)); ?>
                                        ...
                                        <td class="align-middle text-right">
                                            <?php if(!in_array($ReserveMeeting->status, [\App\Models\ReserveMeeting::$finished, \App\Models\ReserveMeeting::$canceled])): ?>
                                                ...
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu menu-lg">
                                                        ...
                                                        <?php if(getFeaturesSettings('agora_for_meeting') and $ReserveMeeting->meeting_type != 'in_person' and $ReserveMeeting->status == \App\Models\ReserveMeeting::$open): ?>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/unicuc/resources/views/web/default/panel/meeting/reservation.blade.php ENDPATH**/ ?>