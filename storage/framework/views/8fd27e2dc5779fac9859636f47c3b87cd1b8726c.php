    ...
    <div class="card">
        <div class="card-header">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_users_export_excel')): ?>
                <a href="<?php echo e(getAdminPanelUrl()); ?>/instructors/excel?<?php echo e(http_build_query(request()->all())); ?>" class="btn btn-primary"><?php echo e(trans('admin/main.export_xls')); ?></a>
            <?php endif; ?>
            <div class="h-10"></div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="media-body">
                                    ...
                                    <div class="text-small font-600-bold"><?php echo e(handlePrice($user->classesSalesSum)); ?></div>
                                </div>
                            </td>
                            <td>
                                <div class="media-body">
                                    <div class="text-primary mt-0 mb-1 font-weight-bold"><?php echo e($user->meetingsSalesCount); ?></div>
                                    <div class="text-small font-600-bold"><?php echo e(handlePrice($user->meetingsSalesSum)); ?></div>
                                </div>
                            </td>
                            <td>
                                <div class="media-body">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hhaseso1/unicuc.emagine.solutions/resources/views/admin/users/instructors.blade.php ENDPATH**/ ?>