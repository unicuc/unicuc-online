        ...
        <div class="row mt-30">
            ...
            <div class="col-12 col-lg-8">
                <div class="form-group">
                    ...
                    <input type="hidden" id="LocationLatitude" name="latitude" value="<?php echo e((!empty($user->location)) ? $user->location[0] : getDefaultMapsLocation()['lat']); ?>">
                    <input type="hidden" id="LocationLongitude" name="longitude" value="<?php echo e((!empty($user->location)) ? $user->location[1] : getDefaultMapsLocation()['lon']); ?>">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/hhaseso1/unicuc.emagine.solutions/resources/views/web/default/panel/setting/setting_includes/settings.blade.php ENDPATH**/ ?>