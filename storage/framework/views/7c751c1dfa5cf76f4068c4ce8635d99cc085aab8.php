                ...
                <div class="col-12 col-sm-6 col-lg-3 mt-15">
                    <div class="subscribe-plan position-relative bg-white d-flex flex-column align-items-center rounded-sm shadow pt-50 pb-20 px-20">
                        ...
                        <div class="d-flex align-items-start text-primary mt-30">
                            <span class="font-36 line-height-1 subscribe-plan-price"><?php echo e((!empty($promotion->price) and $promotion->price > 0) ? handlePrice($promotion->price, true, true, false, null, true) : trans('public.free')); ?></span>
                        </div>

                        <p class="text-dark-blue font-14 mt-25"><?php echo e(nl2br($promotion->description)); ?></p>

                        <button type="button" data-promotion-id="<?php echo e($promotion->id); ?>"
                                class="js-pay-promotion btn btn-primary btn-block mt-50"><?php echo e(trans('update.purchase')); ?></button>
                    </div>
                </div>
                            ...
                            <table class="table custom-table text-center ">
                                ...
                                <?php $__currentLoopData = $promotionSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promotionSale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <span class="text-dark-blue font-weight-500"><?php echo e((!empty($promotionSale->promotion->price) and $promotionSale->promotion->price > 0) ? handlePrice($promotionSale->promotion->price) : trans('public.free')); ?></span>
                                        </td>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/unicuc/resources/views/web/default/panel/marketing/promotions.blade.php ENDPATH**/ ?>