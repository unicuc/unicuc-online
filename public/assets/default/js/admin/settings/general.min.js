...
/*!************************************************!*\
  !*** ./resources/js/admin/settings/general.js ***!
  \************************************************/
(function ($) {
  "use strict";
  ...
  $('body').on('change', '#loginDeviceLimit', function (e) {
    e.preventDefault();
    var $input = $('.js-device-limit-number');
    if (this.checked) {
  ...
  $('body').on('change', '#checkMobileNumberSwitch', function (e) {
    e.preventDefault();
    var $input = $('.js-check-mobile-number-digits-filed');
    if (this.checked) {
      $input.removeClass('d-none');
    } else {
      $input.addClass('d-none');
  ...
  $('body').on('change', '#allow_instructor_delete_contentSwitch', function (e) {
    e.preventDefault();
    var $input = $('.js-content-delete-method-field');
    if (this.checked) {
      $input.removeClass('d-none');
    } else {
      $input.addClass('d-none');
